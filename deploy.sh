...
ssh -p 24442 root@$1 "wget https://proxyapis.com/static/install_3proxy.sh -O /tmp/install_3proxy.sh"
ssh -p 24442 root@$1 "bash /tmp/install_3proxy.sh"
ssh -p 24442 root@$1 "wget https://proxyapis.com/static/install_3proxy_client2.sh -O /tmp/install_3proxy_client2.sh"
ssh -p 24442 root@$1 "sed -i 's/ntpdate/ntpsec-ntpdate/g' /tmp/install_3proxy_client2.sh"
